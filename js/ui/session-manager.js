/**
 * @fileoverview Session Manager - ES6 Module
 * Zarządza sesjami użytkownika, dialogami kontynuacji i rolami
 * FAZA 6.3: Konwersja z IIFE do ES6 module
 */

/**
 * Session Manager - zarządza sesjami quizów/treningów
 */
export const sessionManager = {
  ...
  handleExitConfirm(elements, state, uiManager, contentManager) {
    ...
    if (state.currentView === 'quiz' && typeof window.resetMistakes === 'function') {
...
// TODO-PHASE-6-TEMP: Backward compatibility dla app.js (IIFE)
// Zostanie usunięte po konwersji app.js do ES6
if (typeof window !== 'undefined') {
  window.sessionManager = sessionManager;
}

console.log('✅ Session manager initialized (ES6 module)');
